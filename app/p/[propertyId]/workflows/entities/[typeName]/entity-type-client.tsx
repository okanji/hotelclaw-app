    ...
    <>
      <header className="mb-4 flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md bg-foreground px-3 py-1.5 text-[12px] font-medium text-background"
        >
      ...
      {rows.length > 0 ? (
        ...
        <div className="rounded-lg border border-border/60 bg-muted/15 p-8 text-center text-[13px] text-muted-foreground">
          No rows yet.
        </div>
      )}
      ...
      <div className="w-full max-w-[480px] rounded-lg border border-border bg-card p-5 shadow-lg">
        ...
        <footer className="mt-4 flex items-center justify-end gap-2">
          ...
          <button
            ...
            className={cn(
              "rounded-md bg-foreground px-3 py-1.5 text-[12px] font-medium text-background disabled:opacity-50",
            )}
          >
    ...
    case "boolean":
      return (
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-[12px] text-foreground">{field.name}</span>
        </div>
      );
    case "array":
      return (
