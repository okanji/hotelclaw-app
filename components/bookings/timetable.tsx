...
const STATUS_BLOCK: Record<BookingStatus, string> = {
  pending: "border-amber-500/60 bg-amber-500/15 text-amber-800 dark:text-amber-200",
  confirmed: "border-blue-500/60 bg-blue-500/15 text-blue-800 dark:text-blue-200",
  seated: "border-violet-500/70 bg-violet-500/20 text-violet-800 dark:text-violet-200",
  completed: "border-border bg-muted text-muted-foreground",
  cancelled: "border-border bg-muted/50 text-muted-foreground line-through",
  no_show: "border-red-500/50 bg-red-500/10 text-red-700 line-through dark:text-red-300",
};
