    ...
    <div className="w-80 p-2">
      ...
      {ranges.length === 0 ? (
        <p className="mb-2 text-[12px] text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 text-[11px]">=SUM(Revenue)</code>.
        </p>
      ) : (
      ...
      <div className="rounded-md border border-border/60 p-2">
        ...
        <input
          ...
          className="mb-1 w-full rounded-md border border-border/60 bg-background px-2 py-1 text-[13px] outline-none focus:border-foreground/30"
        />
