        ...
        {days.map((d, i) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={cn(
                  "mt-0.5 grid size-5 place-items-center rounded-full text-[11px] font-semibold tabular-nums",
    ...
    >
      {item.kind === "bar" ? (
        <button
          ...
          className={cn(
            "absolute top-1/2 -translate-y-1/2 truncate rounded-md px-2 text-left text-[11px] font-medium text-white shadow-sm hover:ring-2 hover:ring-white/30",
