          ...
          <div className="flex shrink-0 items-center gap-2 border-b border-border/70 px-4 py-2">
            <div className="flex items-center gap-0.5">
              ...
              <Button
                size="sm"
                variant="ghost"
                className="h-7 px-2 text-[0.75rem] font-medium tracking-tight"
                onClick={goToday}
              >
                Today
              </Button>
            ...
            <span className="ml-1 text-[0.8125rem] font-medium tracking-tight text-foreground">
              {headerLabel}
            </span>
            ...
            <div className="ml-auto flex items-center gap-1.5">
              ...
              <Button
                size="sm"
                variant="ghost"
                className="h-7 gap-1.5 px-2 text-[0.75rem] font-medium tracking-tight"
            ...
            <div className="flex min-w-full">
              ...
              >
                ...
                >
                  ...
                  <span className="text-[0.75rem] font-medium tracking-tight text-foreground">
                    Daily team total
                  </span>
                </div>
              </div>
                  ...
                  >
                    {days.map((d, i) => {
                      ...
                      return (
                        ...
                        >
                          <span className="text-[0.75rem] font-medium tabular-nums tracking-tight text-foreground">
                            {formatHours(total)}
                          </span>
  ...
  return (
    <div className="flex min-w-0 items-center gap-3 rounded-md border border-border/70 bg-card p-3 shadow-xs transition-colors hover:border-foreground/15">
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-[0.6875rem] font-medium tracking-tight text-muted-foreground uppercase">
          {label}
        </p>
        <p className="text-[1.0625rem] leading-tight font-semibold tabular-nums tracking-tight text-foreground">
          {value}
        </p>
        <p className="truncate text-[0.75rem] tracking-tight text-muted-foreground">
          {hint}
        </p>
      </div>
    ...
    <div className="sticky top-0 z-10 h-12 border-b border-border/70 bg-card/95 backdrop-blur">
      <div className="relative h-5 border-b border-border/40">
        {months.map((m) => (
          <span
            key={m.start}
            className="absolute top-0 truncate px-2 text-[11px] font-semibold tracking-wide text-foreground"
            style={{
  ...
  return (
    ...
    >
      <Avatar className="size-8 shrink-0">
        ...
        <AvatarFallback className="bg-muted text-[0.6875rem] font-medium text-foreground">
          {initials(name)}
        </AvatarFallback>
      </Avatar>
      <div className="min-w-0 flex-1">
        <p className="truncate text-[0.8125rem] font-medium tracking-tight text-foreground">
          {name}
        </p>
        <div className="mt-1 flex items-center gap-1.5">
          ...
          <span
            className={cn(
              "shrink-0 text-[0.6875rem] font-medium tabular-nums tracking-tight",
              totalClass,
            )}
          >
    ...
    >
      <Tooltip>
        ...
        >
          <span
            className={cn(
              "relative z-[1] text-[0.8125rem] font-medium tabular-nums tracking-tight",
              tone.text,
            )}
          >
...
function EmptyMembersLabel() {
  return (
    <div
      className="flex items-center gap-2 px-3 text-[0.75rem] tracking-tight text-muted-foreground"
      style={{ height: ROW_HEIGHT }}
    >
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="shrink-0 border-b border-border/70 px-4 py-3">
          <div className="flex items-center gap-2">
            <SheetTitle className="text-[0.8125rem] font-medium tracking-tight">
              Inbox
            </SheetTitle>
            {totalCount > 0 ? (
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {list.length === 0 ? (
          <div className="flex h-32 items-center justify-center px-4 text-center text-[0.75rem] tracking-tight text-muted-foreground">
                ...
                <li key={t.id}>
                  ...
                  >
                    <div className="flex w-full items-start gap-2">
                      ...
                      />
                      <span className="line-clamp-2 flex-1 text-[0.8125rem] leading-4.5 font-medium tracking-tight text-foreground">
                        {t.title}
                      </span>
                    </div>
                    <div className="flex w-full items-center gap-2 pl-3.5 text-[0.6875rem] tracking-tight text-muted-foreground">
                      {t.assignee_id ? (
...
function PanelTabButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "inline-flex h-7 flex-1 items-center justify-center gap-1.5 rounded-md px-1.5 text-[0.6875rem] font-medium tracking-tight transition-colors",
        active
      ...
      <PopoverTrigger
        render={
          <button
            type="button"
            className={cn(
              "inline-flex h-7 items-center gap-1 rounded-md border border-border/70 bg-card px-2 text-[0.75rem] font-medium tracking-tight text-foreground shadow-xs transition-colors",
            ...
            return (
              <li key={opt.id}>
                <button
                  ...
                  className={cn(
                    "flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-left text-[0.8125rem] tracking-tight",
                    selected
