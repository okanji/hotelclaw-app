  ...
  return (
    ...
    >
      <Textarea
        ...
        disabled={pending}
        className="min-h-0 resize-none border-0 bg-transparent px-1 py-1 text-[0.8125rem] leading-[1.125rem] shadow-none focus-visible:ring-0"
      />
      <div className="mt-1 flex items-center justify-between px-1 pb-0.5 text-[0.6875rem] text-muted-foreground">
