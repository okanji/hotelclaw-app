        ...
        {byStatus.map((s) => (
          <li key={s.status}>
            ...
            >
              ...
              <span className="shrink-0 text-[0.8125rem] font-semibold tracking-tight tabular-nums text-foreground">
                {s.count}
              </span>
            </Link>
          </li>
        ...
        return (
          <li key={`${item.kind}-${item.taskId}`}>
            ...
            >
              ...
              {item.assigneeName ? (
                <span className="hidden shrink-0 text-[0.75rem] text-muted-foreground/80 sm:inline">
                  {item.assigneeName}
                </span>
              ) : null}
            </Link>
