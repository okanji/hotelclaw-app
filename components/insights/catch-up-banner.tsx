    ...
    <div className="rounded-lg border border-border/60 bg-muted/20 px-3.5 py-2.5">
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[0.8125rem] leading-relaxed text-pretty text-foreground">
            {summary}
          </p>
          <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-[0.6875rem] text-muted-foreground tabular-nums">
              ...
              {payload.highlights.map((h) => (
                <li key={`${h.taskId}-${h.what}`}>
                  <Link
                    ...
                    className="group flex items-baseline gap-2 text-[0.75rem]"
                  >
