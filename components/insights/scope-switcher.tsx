    ...
    <DropdownMenu>
      <DropdownMenuTrigger
        render={
          <button
            type="button"
            className="inline-flex items-center gap-1.5 rounded-md border border-border/70 px-2.5 py-1.5 text-[0.8125rem] font-medium text-foreground transition-colors hover:bg-muted/50"
          />
        }
      >
