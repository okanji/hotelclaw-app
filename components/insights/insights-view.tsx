        ...
        <div className="mx-auto w-full max-w-6xl px-8 pt-12 pb-24 sm:px-14 sm:pt-14">
          <header className="mb-12 flex items-end justify-between gap-4">
            <div className="flex min-w-0 flex-col gap-1.5">
              <p className="mb-2 text-[0.6875rem] font-medium tracking-[0.18em] text-muted-foreground uppercase">
                Intelligence
              </p>
              <h1 className="text-[2.5rem] leading-none font-semibold tracking-tight text-balance text-foreground">
                {heading}
              </h1>
              <p className="mt-1 max-w-[55ch] text-[0.8125rem] text-pretty text-muted-foreground">
                {blurb}
              </p>
            </div>
            {!isStaff && !showReports ? (
