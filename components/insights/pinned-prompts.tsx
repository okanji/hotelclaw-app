...
function PromptCard({
  ...
  return (
    <article className="group/prompt flex flex-col gap-1.5">
      ...
      {card.answerMd ? (
        <div className="prose prose-sm dark:prose-invert max-w-none text-[0.8125rem] leading-relaxed text-muted-foreground [&_li]:my-0.5 [&_p]:my-1">
      ...
      {card.generatedAt ? (
        <p className="text-[0.6875rem] text-muted-foreground/70 tabular-nums">
