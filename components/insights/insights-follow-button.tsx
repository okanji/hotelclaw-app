    ...
    <>
      <Popover>
        ...
        <PopoverContent align="end" sideOffset={6} className="w-64 p-3">
          <p className="mb-2 text-[0.6875rem] font-medium tracking-[0.14em] text-muted-foreground uppercase">
            Email this lens
          </p>
          ...
          <button
            ...
            className="mt-2 w-full rounded-md border border-border px-2.5 py-1.5 text-[0.75rem] font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          >
...
function InsightsSubscriptionsDialog({
  ...
  const selectClass =
    "h-8 rounded-md border border-input bg-transparent px-2 text-[0.8125rem] text-foreground outline-none focus-visible:ring-1 focus-visible:ring-ring";

  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle className="text-[0.9375rem] font-medium tracking-tight">
            Emails &amp; alerts
          </DialogTitle>
          ...
          <section className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {newMetric !== "project_at_risk" ? (
                <label className="flex items-center gap-1 text-[0.8125rem] text-muted-foreground">
                  &gt;
                  <input
                    type="number"
                    min={0}
                    ...
                    className="h-8 w-16 rounded-md border border-input bg-transparent px-2 text-[0.8125rem] text-foreground outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  />
                </label>
              ) : null}
              <Button
