 ...
 */
function OpsLoading() {
  return <p className="py-4 text-[0.8125rem] text-muted-foreground">Loading…</p>;
}
    ...
    <>
      <Stats
        ...
        {meetings.unownedActionItems > 0 ? (
          <p className="mt-3 text-[0.8125rem] text-pretty text-muted-foreground">
            ...
            {staleSops.map((doc) => (
              <li key={doc.documentId}>
                ...
                >
                  ...
                  <span className="min-w-0 flex-1 truncate text-[0.8125rem] text-foreground group-hover:underline">
                    {doc.title}
                  </span>
              ...
              {automation.topFailing.map((w) => (
                <li key={w.workflowId}>
                  ...
                  >
                    ...
                    <span className="shrink-0 text-[0.75rem] tabular-nums text-rose-500">
                      {w.failures} failure{w.failures === 1 ? "" : "s"}
                    </span>
                    {w.lastError ? (
                      <span className="hidden max-w-56 shrink-0 truncate text-[0.75rem] text-muted-foreground sm:inline">
                        {w.lastError}
                      </span>
                    ) : null}
                  </Link>
