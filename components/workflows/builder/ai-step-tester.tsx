    ...
    <div className="mt-3 rounded-md border border-border/60 bg-muted/20 p-2.5">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          disabled={running}
          className="inline-flex shrink-0 items-center gap-1.5 rounded-md border border-border bg-background px-2 py-1 text-[12px] hover:bg-muted disabled:opacity-50"
        >
          {running ? (
      ...
      {result ? (
        <div className="mt-2">
          ...
          <pre className="max-h-48 overflow-auto rounded-sm bg-muted/40 p-2 font-mono text-[11px] whitespace-pre-wrap text-foreground">
