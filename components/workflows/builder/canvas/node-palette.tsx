      ...
      <div className="border-b p-2">
        <div className="relative">
          ...
          <input
            ...
            className="h-7 w-full rounded-sm border-0 bg-secondary pl-7 pr-2 text-[12px] outline-none focus:ring-1 focus:ring-primary/40"
          />
        </div>
      </div>
              ...
              {items.map((s) => (
                <li key={s.id}>
                  <button
                    ...
                    className={cn(
                      "group flex w-full cursor-grab items-center gap-2 rounded-sm px-2 py-1 text-left text-[12px] hover:bg-secondary",
