...
function FieldInput({
  ...
  const inputClass =
    "h-12 w-full rounded-xl border bg-white px-4 text-base outline-none placeholder:text-[#6f6a60]/60";
    ...
    case "long_text":
      return (
        <textarea
          ...
          className="w-full rounded-xl border bg-white px-4 py-3 text-base outline-none placeholder:text-[#6f6a60]/60"
          style={inputStyle}
        />
      );
    case "number":
