        ...
        <div className="flex flex-wrap gap-1.5">
          {EXAMPLES.map((ex) => (
            <button
              ...
              className="rounded-full border border-border/70 bg-muted/40 px-2.5 py-1 text-[0.75rem] tracking-tight text-muted-foreground transition-colors hover:border-foreground/20 hover:text-foreground disabled:opacity-60"
            >
              {ex}
            </button>
          ))}
