...
export function DocumentHeader({
  ...
  return (
    <div className="document-header group/header">
        ...
        <div className="group/cover relative -mx-6 mb-3 h-44 overflow-hidden md:-mx-12">
          ...
          <div className="absolute bottom-3 right-3 flex gap-1 opacity-0 transition-opacity group-hover/cover:opacity-100">
            <button
              ...
              className="rounded-md bg-background/85 px-2.5 py-1 text-[12px] font-medium text-foreground shadow hover:bg-background"
            >
              Replace
            </button>
            <button
      ...
      <div className="mb-2 flex h-7 items-center gap-3 text-[13px] text-muted-foreground opacity-0 transition-opacity group-hover/header:opacity-100">
        {!icon ? (
          <IconPicker
            onSelect={(emoji) => void setIcon(emoji)}
            trigger={
