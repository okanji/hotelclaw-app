  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="end" sideOffset={6} className="!w-[340px] !p-3">
        ...
        <div className="mb-3 flex items-center gap-2 rounded-md border border-border bg-muted/20 px-3 py-2 text-[12px] text-muted-foreground">
        ...
        <ul className="max-h-72 space-y-1 overflow-y-auto">
          ...
          {(members ?? []).length === 0 ? (
            <li className="px-1.5 py-2 text-[12px] text-muted-foreground">
              No members yet.
            </li>
          ) : null}
        </ul>
