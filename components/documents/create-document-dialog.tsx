  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-md gap-0 p-0 sm:max-w-md">
            ...
            return (
              ...
              >
                ...
                <div className="flex w-full flex-col gap-1">
                  ...
                  <p className="line-clamp-3 text-[0.75rem] leading-relaxed tracking-tight text-muted-foreground">
                    {kind.description}
                  </p>
                </div>
                <span className="text-[0.6875rem] tracking-tight text-muted-foreground/70">
                  {kind.hint}
                </span>
              </button>
            );
        ...
        <div className="border-t border-border/70 px-4 py-2.5 text-[0.6875rem] tracking-tight text-muted-foreground">
          Tip: press{" "}
