    ...
    >
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <h1 className="truncate font-serif text-lg leading-tight font-medium">
            {meta.displayName}
          </h1>
        ...
        {!paused && status !== "human" ? (
          <button
            ...
            disabled={busy || !token}
            className="shrink-0 rounded-full border px-3 py-1.5 text-xs font-medium transition-opacity disabled:opacity-40"
        ...
        >
          ...
          >
            <textarea
              ...
              className="max-h-32 flex-1 resize-none rounded-2xl border bg-white px-4 py-2.5 text-base leading-snug outline-none"
            ...
            <button
              ...
              aria-label="Send"
              className="flex size-11 shrink-0 items-center justify-center rounded-full text-white transition-opacity disabled:opacity-40"
          ...
          <p
            className="mx-auto mt-1.5 max-w-xl text-center text-[11px]"
  ...
  if (role === "guest") {
    return (
      <div className="flex justify-end">
        <div
          className="max-w-[85%] rounded-2xl rounded-br-md px-4 py-2.5 text-[15px] leading-relaxed whitespace-pre-wrap text-white"
          style={{ backgroundColor: accent }}
        >
          {children}
        </div>
    ...
    <div className="flex items-end gap-2">
      ...
      <div className="max-w-[85%]">
        {role === "staff" && staffLabel ? (
          <p className="mb-0.5 ml-1 text-[11px]" style={{ color: INK_SOFT }}>
            {staffLabel}
          </p>
        ) : null}
        <div
          className={`rounded-2xl rounded-bl-md border bg-white px-4 py-2.5 text-[15px] leading-relaxed ${isBot ? "" : "whitespace-pre-wrap"}`}
      ...
      {([1, -1] as const).map((value) => {
        ...
        return (
          <button
            ...
            className="rounded-full border px-1.5 py-0.5 text-[11px] transition-opacity"
            style={{
