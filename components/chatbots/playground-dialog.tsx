    ...
    <div className="flex min-h-[320px] flex-col rounded-lg border border-border">
      ...
      {showInstructions ? (
        <Textarea
          ...
          rows={5}
          className="m-2 font-mono text-[12px]"
        />
      ) : null}
        ...
        {pane.turns.map((t, i) =>
          t.role === "user" ? (
            <div key={i} className="flex justify-end">
              <div className="max-w-[90%] rounded-xl rounded-br-sm bg-foreground px-2.5 py-1.5 text-[12px] whitespace-pre-wrap text-background">
                {t.content}
              </div>
            </div>
          ) : (
            <div key={i} className="space-y-1">
              ...
              <div className="max-w-[90%] rounded-xl rounded-bl-sm border border-border/60 bg-background px-2.5 py-1.5 text-[12px] whitespace-pre-wrap">
                {t.content}
              </div>
              {t.ms ? (
