  ...
  return (
    <TabsTrigger value={value} className="flex-none gap-1.5 px-3">
      ...
      {typeof count === "number" && count > 0 ? (
        <span className="ml-0.5 rounded-full bg-muted px-1.5 text-[0.6875rem] font-medium tabular-nums text-muted-foreground group-data-[variant=line]/tabs-list:in-data-active:bg-foreground/10 group-data-[variant=line]/tabs-list:in-data-active:text-foreground">
          {count}
        </span>
      ) : null}
    </TabsTrigger>
