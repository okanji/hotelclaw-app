...
function Card({
            ...
            >
              ...
              {onSend ? (
                <button
                  ...
                  className="mt-0.5 shrink-0 rounded-lg px-2.5 py-1 text-[12px] font-medium text-white transition-opacity hover:opacity-90"
          ...
          {card.slots.map((slot) => {
            ...
            return onSend ? (
              <button
                ...
                className="rounded-lg border border-zinc-200 bg-zinc-50 px-2.5 py-1 text-[12px] font-medium text-zinc-800 transition-colors hover:border-zinc-300 hover:bg-zinc-100"
              >
                {chip}
              </button>
            ) : (
              <span
                key={slot.startsAt}
                className="rounded-lg border border-zinc-200 bg-zinc-50 px-2.5 py-1 text-[12px] font-medium text-zinc-700"
              >
                {chip}
              </span>
            );
  ...
  return (
    <div className="flex items-start gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5">
      ...
      <div className="min-w-0 text-[12px] leading-snug text-emerald-900">
