      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuGroup>
              <DropdownMenuLabel className="px-2 pt-1 pb-1.5 text-[0.6875rem] font-semibold tracking-wide text-muted-foreground uppercase">
                Properties
              </DropdownMenuLabel>
              {memberships.map((m) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "flex size-8 shrink-0 items-center justify-center rounded-lg text-xs font-bold uppercase",
                        tint,
                      )}
                    >
