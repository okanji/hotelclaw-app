  ...
  return (
    <li>
      ...
      >
        ...
        <span
          className={cn(
            "flex size-8 shrink-0 items-center justify-center rounded-md text-[0.6875rem] font-semibold select-none",
            view.actor
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5">
            ...
            <p
              className={cn(
                "min-w-0 truncate text-[0.8125rem] leading-5 font-medium",
            ...
            {view.channel ? (
              <span
                className={cn(
                  "inline-flex shrink-0 items-center rounded-sm border border-border bg-muted/50 px-1.5 py-px text-[0.6875rem] font-medium",
            ...
            <span className="ml-auto flex shrink-0 items-center gap-1.5 text-[0.6875rem] text-muted-foreground/80 tabular-nums">
          ...
          {view.preview ? (
            <p
              className={cn(
                "mt-0.5 truncate text-[0.8125rem]",
