  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <span className="w-9 shrink-0 text-right text-[0.6875rem] font-medium tabular-nums text-foreground">
  ...
  return (
    <div className="flex min-w-[300px] flex-1 flex-col">
      <div className="mb-3 flex items-center gap-2 px-0.5">
        ...
        <span className="rounded-full bg-muted px-1.5 py-0.5 text-[0.6875rem] font-medium tabular-nums text-muted-foreground">
          {projects.length}
        </span>
      </div>
      <div
      ...
      >
        {projects.length === 0 ? (
          <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-border/50 py-8 text-[0.75rem] text-muted-foreground/70">
            No projects
          </div>
        ) : (
