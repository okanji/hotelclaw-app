...
export function ArchiveView({ propertyId }: { propertyId: string }) {
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-3xl flex-col overflow-y-auto px-8 pt-12 pb-16 sm:px-14 sm:pt-16">
      <header className="flex flex-col gap-3">
        <Link
          href={`/p/${propertyId}/projects`}
          className="flex w-fit items-center gap-1.5 text-[0.8125rem] tracking-tight text-muted-foreground transition-colors hover:text-foreground"
        >
        ...
        <p className="max-w-[56ch] text-[0.9375rem] leading-relaxed tracking-tight text-pretty text-muted-foreground">
  ...
  return (
    <section className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-[0.8125rem] font-medium tracking-tight text-foreground">
          {title}
        </h2>
      ...
      >
        {items.map((item) => (
          ...
          >
            ...
            {item.archived_at ? (
              <span className="hidden shrink-0 text-[0.75rem] tabular-nums text-muted-foreground sm:inline">
