  ...
  return (
    <div className="relative">
      {isEmpty && placeholder ? (
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 select-none text-[15px] leading-[1.45] text-muted-foreground/80"
        >
          {placeholder}
        </span>
      ) : null}
      <div
        ...
        onPaste={onPaste}
        className={cn(
          "rich-editor-content block min-h-[24px] w-full whitespace-pre-wrap break-words text-[15px] leading-[1.45] text-foreground outline-none focus:outline-none focus-visible:outline-none",
          "[&_a]:text-primary [&_a]:underline",
          "[&_code]:rounded [&_code]:bg-[oklch(1_0_0_/_0.08)] [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[13px]",
          "[&_pre]:my-1 [&_pre]:rounded-md [&_pre]:border [&_pre]:border-[oklch(1_0_0_/_0.12)] [&_pre]:bg-[oklch(1_0_0_/_0.05)] [&_pre]:px-2.5 [&_pre]:py-2 [&_pre]:font-mono [&_pre]:text-[13px] [&_pre]:whitespace-pre-wrap [&_pre_code]:bg-transparent [&_pre_code]:p-0",
