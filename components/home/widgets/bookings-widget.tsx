    ...
    <div className="flex flex-col gap-4">
          ...
          return (
            <li key={b.id}>
              <Link
                ...
                className="group flex items-center gap-2 text-[0.8125rem] text-muted-foreground hover:text-foreground"
              >
                <span
                  className={cn(
      ...
      {pendingCount > 0 ? (
        <Link
          ...
          className="border-t border-border/60 pt-3 text-[0.75rem] text-muted-foreground hover:text-foreground"
        >
