          ...
          <li key={n.id}>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-[0.8125rem] leading-snug tracking-tight text-foreground">
                  {v.lead}
                </p>
                {v.sub ? (
                  <p className="mt-0.5 truncate text-[0.75rem] tracking-tight text-muted-foreground">
                    {v.sub}
                  </p>
                ) : null}
              </div>
