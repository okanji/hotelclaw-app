          ...
          {step === "details" && slot ? (
            <form onSubmit={submit} className="flex flex-col gap-4">
              ...
              <Field label="Phone (optional)">
                <TextInput value={phone} onChange={setPhone} name="guestPhone" placeholder="+1 415 555 0100" />
              </Field>
              <Field label="Anything we should know? (optional)">
                <TextInput value={notes} onChange={setNotes} name="notes" placeholder="Window seat, anniversary…" />
              </Field>
