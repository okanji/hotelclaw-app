 ...
 * calc artifact), warm ring + faint fill when off, Notion blue (`--ring`)
 * when on, white thumb. Only the thumb transform and the track fill animate.
 */
function Switch({
  className,
  size = "default",
