...
/**
 * Notion toggle button: 6px radius everywhere, fill-only hover (`bg-accent`)
 * with no label color flip, pressed state = the pressed warm rung
 * (`bg-accent-pressed`), 1px blue focus. The `outline` variant carries the
 * warm ring as a box-shadow, not a border.
 */
