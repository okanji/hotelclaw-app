...
function ToggleGroupItem({
  ...
  return (
    <TogglePrimitive
      ...
      className={cn(
        // Joined groups (spacing=0) square the inner edges and round only the
        // two ends — on the same 6px rung as every other control. The old
        // `data-[variant=outline]:border-*` stitching is gone with the border
        // itself: outline items carry the warm ring as a box-shadow now.
