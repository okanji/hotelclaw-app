  ...
  try {
    ...
    const result = await generateText({
      ...
      system: [
        ...
        "- `docs` (0-6): starter SOP / playbook document TITLES their departments + priorities call for (e.g. 'Opening checklist', 'Guest complaint handling SOP', 'Shift handover playbook', 'Emergency procedures'). Titles only — the team fills the content. Each with a single-emoji icon.",
