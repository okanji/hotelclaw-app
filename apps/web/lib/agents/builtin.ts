...
export const BUILTIN_AGENTS: BuiltinAgentInfo[] = [
  {
    ...
    tools: [
      "Tasks (list + full-text search incl. done)",
      "Documents (search + list, incl. attached-PDF text)",
      "Meetings (past + upcoming)",
      "Bookings (any window)",
      "Chat history search (your channels only)",
      "Forms + response summaries",
      "Guest chatbot activity",
      "Insights brief / weekly report / handovers (owner+manager only)",
      "Org chart",
      "Create tasks",
      "Render rich UI",
      "Shared brain (search, read, list, think, capture)",
    ],
    model: "Sonnet",
  },
  {
